...
Sinatra is intended to be used as a parent theme, for themes that want to drop most of the Drupalness.
...
{% endblock block_full %}
```
Which allows any theme using Sinatra as base theme to change the label for blocks as follows:
